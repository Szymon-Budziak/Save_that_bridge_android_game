...
import unina.game.development.savethatbridge.logic.Pool;
import unina.game.development.savethatbridge.logic.Pool.PoolObjectFactory;
...
public class MultiTouchHandler implements TouchHandler {
    ...
    public synchronized boolean isTouchDown(int pointer) {
        ...
        else return isTouching[pointer];
    }
